 ...
 * @author Usuario
 */
public class FormulariosFornecedores extends javax.swing.JFrame {
    ...
    public FormulariosFornecedores() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        tabela.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "id", "nome", "CNPJ/CPF", "e-mail", "celular", "telefone", "cep", "endereço", "numero", "complemento", "bairro", "cidade", "UF"
            }
        ));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormulariosFornecedores.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormulariosFornecedores().setVisible(true);
            }
        });
    }
