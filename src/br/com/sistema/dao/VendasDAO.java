...
public class VendasDAO {
    ...
    public void salvar(Vendas obj){
        ...
        public List<Vendas>historiVendas(LocalDate data_inicio, LocalDate data_fim){
            try {
                List<Vendas>lista = new ArrayList<>();
                String sql = "select v.id,c.nome,date_format(v.data_venda, '%d/%m/%Y')"
                        + "as data_formatada,v.total_venda,v.observacoes from tb_vendas as v inner join tb_clientes as c on(v.cliente_id=c.id) "
        ...
        public double posicaoDoDia(LocalDate data_venda){
            try {
                ...
                throw new RuntimeException("erro ao retornar a posicao do dia:" + e);
            }
        }
