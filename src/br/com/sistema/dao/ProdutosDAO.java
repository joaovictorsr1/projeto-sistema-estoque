    ...
    public void Salvar(Produtos obj) {
        try {
            ...
            String sql = "insert into tb_produtos (descricao, preco, qtd_estoque, for_id)"
                    + "values(?,?,?,?)";
            // Preparar a conexao SQL para se conectar com o banco
    ...
    public List<Produtos>listar() {
        ...
        public void adicionarEstoque(int id, int qtd_nova){
            try {
                ...
                JOptionPane.showMessageDialog(null,"erro adicionar ao estoque" + e);
            }
        }
        ...
        public void baixaEstoque(int id, int qtd_nova){
            try {
                ...
                JOptionPane.showMessageDialog(null,"erro dar baixa no estoque" + e);
            }
        }
        ...
        public int retornaQtdAtualEstoque(int id){
            try {
                ...
                throw new RuntimeException("erro ao retornar o estoque atual!" + e);
            }
        }
